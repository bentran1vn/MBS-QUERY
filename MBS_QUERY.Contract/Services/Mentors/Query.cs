...
public class Query
{
    public record GetMentorsQuery(string? SearchTerm, string? SortColumn, SortOrder? SortOrder, int PageIndex, int PageSize) : IQuery<PagedResult<Response.GetAllMentorsResponse>>, ICacheable
    {
